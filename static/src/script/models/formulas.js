...
let molalidad_f = new Formula([], ['molalidad=(n_s*1000)/m_d', 'n_s=(molalidad*m_d)/1000', '(m_d=n_s*1000)/molalidad'])
let frac_molar_f = new Formula([], ['f_m=n_s/(n_s+n_d)'])
let masa_molar_s_f = new Formula([], ['m_mol_s=m_s/n_s', 'm_s=m_mol_s/n_s', 'n_s=m_s/m_mol_s'])
let masa_molar_d_f = new Formula([], ['m_mol_d=m_d/n_d', 'm_d=m_mol_d/n_d', 'n_d=m_d/m_mol_d'])
let masa_molar_D_f = new Formula([], ['m_mol_D=m_D/n_D', 'm_D=m_mol_D/n_D', 'n_D=m_D/m_mol_D'])
